 ...
 /* forma el array para los nombres de las columnas del JTable */
                ...
                for (int fila = 0; fila < hoja.getRows(); fila++) {
                    for (int columna = 0; columna < hoja.getColumns(); columna++) {
                        ...
                        if (columna == 0) {
                            columNames[columna] = "Numero de empleado";
                        }
                        else if(columna == 1){
                            columNames[columna] = "Nombre";
                        }else if(columna == 2){
                            columNames[columna] = "Departamento";
                        }else if(columna == 3){
                            columNames[columna] = "Comida";
                        }else if(columna == 4){
                            columNames[columna] = "Hora de desayuno";
                        }else if(columna == 5){
                            columNames[columna] = "Hora de comida";
                        }else if(columna == 6){
                            columNames[columna] = "Hora de cena";
                        }else if(columna == 7){
                            columNames[columna] = "Hora de merienda";
                        }
